                        ...
                        >
                            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                ...
                                <div className="flex flex-col items-center p-8">
                                    ...
                                    <p className="text-center mb-6 px-6 text-base text-darkgrey">Sharing a link to your article and why it sould be reviewed or published, will increase the chances</p>
                                    {
                                        withTitle &&
                                        <input
                                            type="text"
                                    ...
                                    <button
                                        type="button"
                                        className={clsx(!canSubmit ? "bg-gray91" : "", "inline-flex items-center justify-center rounded-full border border-transparent bg-primary w-full py-3 text-base font-medium text-white shadow-sm")}
                                        disabled={!canSubmit}
