        ...
        {data.map((item, index) => {
          return (
            <div key={index} className={`flex flex-col ${data.length === 2 ? "w-1/2" : ""}`}>
              ...
              <div className="flex text-5xl font-semibold">{item.amount}</div>
            </div>
          );
        })}
      </div>
