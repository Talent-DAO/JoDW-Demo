...
const NotificationCard = ({ state }) => {
  ...
  return (
    <div className="flex flex-row rounded-md border border-gray bg-bordergrey p-4">
      <div className="w-30">
        <div className="flex-auto w-20 h-20 relative rounded-full flex overflow-hidden bg-gray">
      ...
      <div className="flex flex-col text-left space-y-3 px-4">
        <div className="flex flex-row">
          ...
          <div className="text-xl text-textgrey ml-1">on Metaverse, NFT & DEFI, the new wave</div>
        </div>
